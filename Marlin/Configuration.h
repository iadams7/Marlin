...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define BACK_PROBE_BED_POSITION 13+122 //safe back position for flat proximity sensor

    // FG these are the values for traditional front mounted proximity sensor
    ...
    // #define RIGHT_PROBE_BED_POSITION 17+143 //corresponds to the bolt in the bed assembly as a fail safe UNTESTED
    // #define FRONT_PROBE_BED_POSITION 13 //corresponds to the bolt in the bed assembly as a fail safe UNTESTED
    // #define BACK_PROBE_BED_POSITION 13+132 //corresponds to the bolt in the bed assembly as a fail safe UNTESTED
