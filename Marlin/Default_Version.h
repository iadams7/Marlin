...
#if true
#define SHORT_BUILD_VERSION "JB Pre-Release RC3 Based"
#define DETAILED_BUILD_VERSION "JB configured 1.1.0-RC3 From Archive"
#define STRING_DISTRIBUTION_DATE "Feb 2016"
